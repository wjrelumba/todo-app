  ...
  return (
    <ToastLayout>
      <div className='d-flex align-items-center justify-content-center vh-100 vw-100 p-3'>
        <div className='d-flex flex-column align-items-center lexOrangePurple w-100 h-100 rounded-3 p-4'>
          <h1 className='fs-2 text-white'>Interns: To Do</h1>
          <div className='d-flex justify-content-between w-100'>
            <button onClick={togglePrev} className='w-100 lexOrange rounded-2 m-1'>
            ...
            <button onClick={toggleAdd} className='w-100 lexOrange rounded-2 m-1'>
            ...
            <div className='d-flex w-100 h-100 justify-content-center overflow-hidden'>
              <div className='d-flex flex-column w-100 h-100'>
                <div className='d-flex w-100 h-100 rounded-2 overflow-auto'>
                  <ToDo setPreviewMode={setPreviewMode} setAddMode={setAddMode} setDelMode={setDelMode} />
                </div>
              </div>
            </div>
          )}
